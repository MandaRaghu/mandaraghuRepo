-- Count of Crew Members By Supervisor, By Most Recently Completed Week Ending Date, DB Server: DMZ-SQL2016CL (10.1.2.13), Database: Timesheets

SELECT		TSH.WeekEndingDate, EMP.AREA_SUPERVISOR_NUMBER, EMP.AREA_SUPERVISOR_NAME, COUNT(DISTINCT PERSON_NUMBER) Crew_Members
